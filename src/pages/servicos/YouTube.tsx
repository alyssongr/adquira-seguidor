...
const SERVICES = [
  {
    id: "inscritos",
    name: "Inscritos Reais",
    description: "Aumente sua base de inscritos com público qualificado",
    gradient: "from-red-600 to-orange-500",
    accentBorder: "border-red-500",
    accentShadow: "shadow-[0_20px_45px_-12px_rgba(239,68,68,0.45)]",
    summaryGradient: "from-red-500/10 to-orange-500/10",
    summaryBorder: "border-red-500/20",
    priceText: "text-red-600 dark:text-red-400",
    unitLabel: "inscritos",
    icon: Youtube,
    inputs: [
      {
  ...
  },
  {
    id: "curtidas",
    name: "Likes Premium",
    description: "Mais likes para aumentar a prova social dos seus vídeos",
    gradient: "from-orange-600 to-yellow-500",
    accentBorder: "border-orange-500",
    accentShadow: "shadow-[0_20px_45px_-12px_rgba(249,115,22,0.45)]",
    summaryGradient: "from-orange-500/10 to-yellow-500/10",
  ...
  {
    id: "visualizacoes",
    name: "Visualizações Segmentadas",
    description: "Impulsione suas visualizações com retenção garantida",
    gradient: "from-yellow-600 to-orange-500",
    accentBorder: "border-yellow-500",
    accentShadow: "shadow-[0_20px_45px_-12px_rgba(234,179,8,0.45)]",
    summaryGradient: "from-yellow-500/10 to-orange-500/10",
    summaryBorder: "border-yellow-500/20",
    priceText: "text-yellow-600 dark:text-yellow-500",
          ...
          <div className="max-w-6xl mx-auto space-y-8">
            <Card className="border-2 border-border/40 bg-background/80 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardDescription>
                  Selecione o formato ideal para acelerar seus resultados no YouTube
                </CardDescription>
              </CardHeader>
              <CardContent>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <p className="text-sm text-muted-foreground">
                    Cada campanha é monitorada para garantir retenção real e métricas orgânicas.
                  </p>
